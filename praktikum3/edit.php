		...
		<div class="content">
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="tanggal_lahir" value="" class="input-group date form-control" date="" data-date-format="yyyy-mm-dd" placeholder="0000-00-00" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="no_telepon" value="" class="form-control" placeholder="No Telepon" required>
					</div>
				</div>
				<div class="form-group">
                    ...
                    <div class="col-sm-3">
                    <b>Jabatan Sekarang :</b> <span class="label label-success"></span>
				    </div>
				</div>
				<div class="form-group">
                    ...
                    <div class="col-sm-3">
                    <b>Status Sekarang :</b> <span class="label label-info"></span>
				    </div>
                </div>
