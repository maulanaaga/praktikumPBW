		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="add.php">Input Data</a></li>
				</ul>
			</div><!--/.nav-collapse -->
		</div>
	</nav>
				...
				if(mysqli_num_rows($cek) == 0){
					if($pass1 == $pass2){
						...
						if($insert){
							...
							echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Ups, Data tidak berhasil disimpan!</div>';
						}
					}else{
					...
					echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>NIK yang anda isi sudah ada</div>';
				} 
